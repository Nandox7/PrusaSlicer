...
const std::vector<std::string>& Preset::printer_options()
{
    ...
    if (s_opts.empty()) {
        s_opts = {
            ...
            "host_type", "print_host", "printhost_apikey", "printhost_cafile", "printhost_printername",
...
const std::vector<std::string>& Preset::sla_printer_options()
{
    ...
    if (s_opts.empty()) {
        s_opts = {
            ...
            "print_host", "printhost_apikey", "printhost_cafile", "printhost_printername",
            "printer_notes",
            "inherits"
        };
    }
    ...
    bool                         select)
{
    ...
    if (found) {
	    ...
	    if (profile_host_params_same_or_anonymized(it->config, cfg) == ProfileHostParams::Anonymized) {
            ...
            opt_update("printhost_printername");
	    }
    }
